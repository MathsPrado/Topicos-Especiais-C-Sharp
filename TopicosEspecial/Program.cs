...
namespace TopicosEspecial
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(teste.Ticks); // Ticks (100 NanoSegundo);
            ...
            Console.WriteLine("d1: " + d1); Console.WriteLine("d1 Kind: " + d1.Kind);
            ...
            // cuidado! Console.WriteLine(d2.ToUniversalTime().ToString("yyyy-MM-ddTHH:mm:ssZ"));
        }
    }
}
